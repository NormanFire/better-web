...
export default {
  ...
  methods: {
    ...
    delete(roleIds) {
      this.loading = true
      this.$delete(`upms/role/${roleIds}`).then(() => {
        this.$message({
      ...
      this.$refs.form.validate((valid) => {
        if (valid) {
          ...
          if (this.role.roleId) {
            ...
            this.$put('upms/role', { ...this.role }).then(() => {
            ...
            this.role.menuIds = this.$refs.permsTree.getCheckedKeys().join(',')
            this.$post('upms/role', { ...this.role }).then(() => {
              this.buttonLoading = false
              this.$message({
    ...
    fetch(params = {}) {
      ...
      this.$get('upms/role', { ...params }).then((r) => {
